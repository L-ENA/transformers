...
def squad_evaluate(examples, preds, no_answer_probs=None, no_answer_probability_threshold=1.0):
    ...
    exact, f1, prec, recall = get_raw_scores(examples, preds)
    ...
    precision_threshold = apply_no_ans_threshold(prec, no_answer_probs, qas_id_to_has_answer, no_answer_probability_threshold)
